...
export const NAV_GROUPS: NavGroup[] = [
  { label: "Dashboard", icon: LayoutDashboard, href: "/admin" },
  {
    ...
    items: [
      ...
      { label: "Intro Video", href: "/admin/home/video-intro" },
      { label: "Statistics", href: "/admin/home/statistics" },
      { label: "Career Timeline", href: "/admin/home/timeline" },
      { label: "Certificates", href: "/admin/home/certificates" },
      { label: "Specialties", href: "/admin/home/specialties" },
      { label: "Doctor Message", href: "/admin/home/doctor-message" },
