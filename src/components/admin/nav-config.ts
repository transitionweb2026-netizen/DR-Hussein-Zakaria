...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "About Doctor", href: "/admin/about-doctor/biography" },
      { label: "Intro Video", href: "/admin/about-doctor/video-intro" },
      { label: "Statistics", href: "/admin/about-doctor/statistics" },
      { label: "Career", href: "/admin/about-doctor/career" },
      { label: "Certificates", href: "/admin/about-doctor/certificates" },
      { label: "Main Specialties", href: "/admin/about-doctor/specialties" },
      { label: "Doctor's Message", href: "/admin/home/doctor-message" },
