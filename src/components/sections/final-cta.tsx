        ...
        <Reveal>
          <GlassCard tone="deep" className="relative overflow-hidden px-6 py-10 text-center sm:px-10 sm:py-12">
            ...
            <div className="relative mx-auto max-w-xl">
              <h2 className="text-2xl font-extrabold text-white sm:text-3xl">{title ?? t("title")}</h2>
              <p className="mt-2.5 text-sm text-white/70 sm:text-base">{subtitle ?? t("subtitle")}</p>
